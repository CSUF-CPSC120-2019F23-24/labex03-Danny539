...
int main()
{
  ...
  char my_char1 = 85;   // decimal
  char my_char2 = 0x55; // hex
  char my_char3 = 'U';  // character

  char my_char4 = 43; // plus sign
  char my_char5 = 0x2B;// plus sign
  ...
  std::cout << my_char << "A Char is stored in" << sizeof(my_char) << " bytes\n" ;

  float my_float = 4;

  std::cout << my_float << "A float is stored in" << sizeof(my_float) << " bytes\n" ;
